...
namespace EARGE.iyzico.Services
{
    ...
    public static class iyzicoHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetPaypalUrl(iyzicoSettingsBase settings)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetPaypalServiceUrl(iyzicoSettingsBase settings)
        {
            return settings.UseSandbox ?
        ...
        /// </summary>
        /// <returns></returns>
        public static CustomSecurityHeaderType GetPaypalApiCredentials(iyzicoApiSettingsBase settings)
        {
            ...
            customSecurityHeaderType.Credentials.Username = settings.ApiKey;
            customSecurityHeaderType.Credentials.Password = settings.SecretKey;
        ...
        public static PaymentActionCodeType GetPaymentAction(iyzicoExpressPaymentSettings payPalExpressPaymentSettings)
        {
