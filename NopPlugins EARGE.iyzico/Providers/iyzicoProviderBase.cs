...
{
    public abstract class iyzicoProviderBase<TSetting> : PaymentMethodBase, IConfigurable where TSetting : iyzicoApiSettingsBase, ISettings, new()
    {
        protected iyzicoProviderBase()
		{
		...
		public PluginHelper Helper 
		{
			get
			{
				if (_helper == null)
				{
					_helper = new PluginHelper(this.ComponentContext, "EARGE.iyzico", GetResourceRootKey());
				}
				return _helper;
			}
		}
        ...
        public override CapturePaymentResult Capture(CapturePaymentRequest capturePaymentRequest)
        {
            ...
            req.DoCaptureRequest.Version = iyzicoHelper.GetApiVersion();
            ...
            //    string error = "";
            //    bool success = iyzicoHelper.CheckSuccess(_helper, response, out error);
            //    if (success)
            //    {
        ...
        public override RefundPaymentResult Refund(RefundPaymentRequest request)
        {
            ...
            req.RefundTransactionRequest.Version = iyzicoHelper.GetApiVersion();
            req.RefundTransactionRequest.TransactionID = transactionId;

            //using (var service = new iyzicoAPISoapBinding())
            //{
            //    service.Url = iyzicoHelper.GetPaypalServiceUrl(settings);
            //    service.RequesterCredentials = iyzicoHelper.GetPaypalApiCredentials(settings);
        ...
        public override VoidPaymentResult Void(VoidPaymentRequest request)
        {
            ...
            req.DoVoidRequest.Version = iyzicoHelper.GetApiVersion();
        ...
        public override CancelRecurringPaymentResult CancelRecurringPayment(CancelRecurringPaymentRequest request)
        {
            ...
            req.ManageRecurringPaymentsProfileStatusRequest.Version = iyzicoHelper.GetApiVersion();
            ...
            //    string error = "";
            //    if (!iyzicoHelper.CheckSuccess(_helper, response, out error))
            //    {
            //        result.AddError(error);
            //    }
            //}
